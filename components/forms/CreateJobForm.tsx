          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 ">
              ...
              />
                ...
                name="employmentType"
                render={({ field }) => (
                  <FormItem id={`${baseId}-employmentType`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 ">
              ...
              <FormItem id={`${baseId}-salaryRange`}>
            ...
            <FormField
              ...
              name="jobDescription"
              render={({ field }) => (
                <FormItem id={`${baseId}-jobDescription`}>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                name="companyName"
                render={({ field }) => (
                  <FormItem id={`${baseId}-companyName`}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem id={`${baseId}-companyLocation`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                name="companyWebsite"
                render={({ field }) => (
                  <FormItem id={`${baseId}-companyWebsite`}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem id={`${baseId}-companyXAccount`}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem id={`${baseId}-companyDescription`}>
            ...
            <FormField
              ...
              name="companyLogo"
              render={({ field }) => (
                <FormItem id={`${baseId}-companyLogo`}>
        ...
        <Card>
          ...
          <CardContent>
            <FormField
              ...
              render={({ field }) => (
                <FormItem id={`${baseId}-listingDuration`}>
                  <FormControl>
